<template><div><p>There is the default example for <code v-pre>Blacksheep</code> framework.</p>
<p>We strongly recommend to use the following example as a standard way to use <code v-pre>PSQLPy</code> with <code v-pre>Blacksheep</code> framework.</p>
